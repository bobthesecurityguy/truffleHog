...
def main():
    ...
    repo_group.add_argument("--repo_path", type=str, dest="repo_path", help="Path to the cloned repo. If provided, git_url will not be used")
    repo_group.add_argument('git_url', nargs="?", type=str, help='URL for secret searching')
